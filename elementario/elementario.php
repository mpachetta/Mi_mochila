...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/img/casa_ico.png>
    <meta charset=" utf-8" />
    ...
    <script src="elementario.js"></script>
...
<body>
    ...
    <div id="contenedor">
        ...
        <div class="pantallaInicial">
            <h1 class="titulo">ELEMENTARIO</h1>
            <img src="img/casa_ico.png" width="150px">
            <div id="usuName">
...
echo pedir_puntos('pts_elementario');
echo '"></input>';
echo "</div>";
}else{
