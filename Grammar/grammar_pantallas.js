...
cont_pantalla_great = `<div class="cont_pantallas"><img src="pen.png" alt="" id="logo" width="150px">
    ...
    <span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">Musical</span> por <span xmlns:cc="http://creativecommons.org/ns#" property="cc:attributionName">Martín Pachetta</span>
...
cont_pantalla_selectGame = `<div class="cont_pantallas"><h2>Elige el juego</h2>  
       <div class="cont_pantallas_child">
        <img src="select_masculino-y-femenino.png" class="select_game" alt="">
        <input type="button" class="boton_select" value="Singular">
        <img src="select_masculino-y-femenino.png" alt="" class="select_game">
        <input type="button" class="boton_select" value="Plural">
        <img src="select_singular-y-plural2.png" alt="" class="select_game">
        <input type="button" class="boton_select" value="Singular/Plural">
</div>
<div class="b_usuname" id="b_salir"><a href="../zona_juegos.php" style="text-decoration:none;">Salir del juego</a></div>
</div>`

cont_pantalla_premios = `<div class="cont_pantallas"><img src="logo_headphones.png" alt="" id="logo_min" width="150px">
        <h1>GRAMMAR</h1>
        <label for="usuName2" class="mensaje">¡Felicitaciones!</label>
        <input type="text" id="usuName_alt" class="usuName_alt" readonly=true value="">
        <div id="puntaje"></div>
        <div id="premios"></div>
        <button id="salir_premios">CONTINUAR</button></div>`
...
trofeo=`<img src="trofeo.png" alt="trofeo">`
